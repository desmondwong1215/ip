...
class EventTest {
    ...
    void fromInput_validInputWithTime_success() throws HelperBotArgumentException {
        ...
        Event event = Event.fromInput(input);
    ...
    void toStrInFile_eventWithTime_correctFormat() {
        ...
        assertEquals("E,0,go to the gym,2025-11-10,17:30,2025-11-10,19:00", event.toStrInFile());
    }
    ...
    void toStrInFile_eventWithoutTime_correctFormat() {
       ...
       null,
        ...
        assertEquals("E,0,take a trip,2025-12-20,,2025-12-25,", event.toStrInFile());
    }
}
